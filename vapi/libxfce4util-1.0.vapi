/* libxfce4util-1.0.vapi generated by vapigen-0.56, do not modify. */

[CCode (cprefix = "Xfce", gir_namespace = "Libxfce4util", gir_version = "1.0", lower_case_cprefix = "xfce_")]
namespace Xfce {
	[CCode (cheader_filename = "libxfce4util/libxfce4util.h", type_id = "xfce_consolekit_get_type ()")]
	public class Consolekit : GLib.Object {
		[CCode (has_construct_function = false)]
		protected Consolekit ();
		[Version (since = "4.19.1")]
		public bool can_hibernate (out bool can_hibernate, out bool auth_hibernate) throws GLib.Error;
		[Version (since = "4.19.1")]
		public bool can_hybrid_sleep (out bool can_hybrid_sleep, out bool auth_hybrid_sleep) throws GLib.Error;
		[Version (since = "4.19.1")]
		public bool can_power_off (out bool can_power_off, out bool auth_power_off) throws GLib.Error;
		[Version (since = "4.19.1")]
		public bool can_reboot (out bool can_reboot, out bool auth_reboot) throws GLib.Error;
		[Version (since = "4.19.1")]
		public bool can_suspend (out bool can_suspend, out bool auth_suspend) throws GLib.Error;
		[Version (since = "4.19.1")]
		public static Xfce.Consolekit @get ();
		[Version (since = "4.19.1")]
		public bool hibernate (bool polkit_interactive) throws GLib.Error;
		[Version (since = "4.19.1")]
		public bool hybrid_sleep (bool polkit_interactive) throws GLib.Error;
		[Version (since = "4.19.1")]
		public bool power_off (bool polkit_interactive) throws GLib.Error;
		[Version (since = "4.19.1")]
		public bool reboot (bool polkit_interactive) throws GLib.Error;
		[Version (since = "4.19.1")]
		public bool suspend (bool polkit_interactive) throws GLib.Error;
	}
	...
	[CCode (cheader_filename = "libxfce4util/libxfce4util.h", type_id = "xfce_systemd_get_type ()")]
	public class Systemd : GLib.Object {
		...
		public bool can_suspend (out bool can_suspend, out bool auth_suspend) throws GLib.Error;
		[Version (since = "4.19.1")]
		public static Xfce.Systemd @get ();
		[Version (since = "4.19.1")]
		public bool hibernate (bool polkit_interactive) throws GLib.Error;
		[Version (since = "4.19.1")]
		public bool hybrid_sleep (bool polkit_interactive) throws GLib.Error;
	...
	[Version (deprecated = true, deprecated_since = "4.17")]
	public static void append_quoted (GLib.StringBuilder string, string unquoted);
	[CCode (cheader_filename = "libxfce4util/libxfce4util.h")]
	[Version (since = "4.17.1")]
	public static string create_shared_thumbnail_path (string uri, string size);
	[CCode (cheader_filename = "libxfce4util/libxfce4util.h")]
	public static string expand_desktop_entry_field_codes (string command, GLib.SList<string> uri_list, string icon, string name, string uri, bool requires_terminal);
	[CCode (cheader_filename = "libxfce4util/libxfce4util.h")]
	[Version (since = "4.2")]
	public static string expand_variables (string command, string envp);
	[CCode (cheader_filename = "libxfce4util/libxfce4util.h")]
	[Version (since = "4.17")]
	public static string? g_file_create_checksum (GLib.File file, GLib.Cancellable? cancellable = null) throws GLib.Error;
	[CCode (cheader_filename = "libxfce4util/libxfce4util.h")]
	[Version (since = "4.17")]
	public static bool g_file_is_trusted (GLib.File file, GLib.Cancellable? cancellable = null) throws GLib.Error;
	[CCode (cheader_filename = "libxfce4util/libxfce4util.h")]
	[Version (since = "4.17")]
	public static bool g_file_metadata_is_supported (GLib.File file);
	[CCode (cheader_filename = "libxfce4util/libxfce4util.h")]
	[Version (since = "4.17")]
	public static bool g_file_set_trusted (GLib.File file, bool is_trusted, GLib.Cancellable? cancellable = null) throws GLib.Error;
	[CCode (cheader_filename = "libxfce4util/libxfce4util.h")]
	[Version (since = "4.17")]
	public static void g_string_append_quoted (GLib.StringBuilder string, string unquoted);
	[CCode (cheader_filename = "libxfce4util/libxfce4util.h")]
	...
	public static Xfce.Rc rc_config_open (Xfce.ResourceType type, string resource, bool readonly);
	[CCode (cheader_filename = "libxfce4util/libxfce4util.h")]
	[Version (replacement = "Rc.simple_open", since = "4.2")]
	public static Xfce.Rc rc_simple_open (string filename, bool readonly);
	...
	[CCode (cheader_filename = "libxfce4util/libxfce4util.h")]
	[Version (since = "4.17")]
	public static string? str_replace (string str, string pattern, string replacement);
	[CCode (cheader_filename = "libxfce4util/libxfce4util.h")]
	public static void textdomain (string package, string localedir, string encoding);
	[CCode (cheader_filename = "libxfce4util/libxfce4util.h")]
	[Version (since = "4.18")]
	public static string unescape_desktop_entry_value (string value);
	[CCode (cheader_filename = "libxfce4util/libxfce4util.h")]
	[Version (since = "4.2")]
